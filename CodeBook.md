...
The rest of the variables are from the accelerometer and gyroscope 3-axial raw signals.
...
2.	The mean and standard deviation measurements are extracted for each measurement
3.	Descriptive activity names are assigned to  the data set
